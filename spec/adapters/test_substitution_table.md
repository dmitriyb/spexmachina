...
- op has deps: `[{ref:op,op_id:op-component-c3d4e5f6a1b2}, {ref:task,task_id:br-77}]` — the two shapes the changeset admits, neither carrying an edge-type key.
...
- op-component-e5f6a1b2c3d4 deps on op-component-d4e5f6a1b2c3 (ref:op). op-component-d4e5f6a1b2c3 errored.
...
- op-component-c3d4e5f6a1b2 was a create whose label matched an existing task: receipted `ok` with was_existing=true and task_id=br-10 (the existing task). op-component-e5f6a1b2c3d4 deps on op-component-c3d4e5f6a1b2.
...
- op-component-b2c3d4e5f6a1 carries a dep written in the v3 task-ref spelling — the retired discriminator and its id key, as `scripts/testdata/substitution/legacy_ref/changeset.json` fixes them.
