...
- Carry the frame documents, the built-in default profile document `defaultProfile.json` and [[d125b5e775b4|BeadMapSchema]] inside the binary — [[b7c3bccd7c64|the schemas travel with the executable]], so validation needs no file beside it and no network.
