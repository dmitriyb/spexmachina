...
VersionCommand is a child of [[b6758cdfabc4|RootCommand]] — one of the nineteen constructors attached in the binary's single registration call — and it inherits the root's persistent flags while reading none of them, so `--spec-dir` changes nothing about its output.
