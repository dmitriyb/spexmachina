...
// TODO(bead:spexmachina-y0wc.20): ContextResolver is being migrated onto
// MappingStore (spexmachina-y0wc.19 replaced mapping.Record/mapping.Store,
// which this file's ResolveContext depended on, with the journal-backed
// MappingStore/FoldEntry). Re-derive ContextResult/ResolveContext against
// FoldEntry per spec/map/arch_context_resolver.md and re-enable this file.
//
