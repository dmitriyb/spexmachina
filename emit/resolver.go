...
// any method.
//
// TODO(bead:spexmachina-y0wc.29): ResolveDeps/ResolveParent below (removed
// pending re-derivation) read the mapping store for bead correlation
// (mapping.Store.GetBySpecNode/GetByProposalEpic), both retired by
// spexmachina-y0wc.19's migration of MappingStore onto the journal. Priority
// carries no mapping.Store dependency and is kept live.
...
// TODO(bead:spexmachina-y0wc.29): re-derive against the journal-backed
